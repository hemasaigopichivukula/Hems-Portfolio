...
export default function Navigation() {
  ...
  return (
    <nav id="navbar" className={`bg-blue-900/95 backdrop-blur-sm text-white ${scrolled ? 'py-2' : 'py-4'} px-6 fixed top-0 left-0 right-0 z-50 shadow-md transition-all duration-300`}>
